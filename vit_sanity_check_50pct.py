#!/usr/bin/env python3
"""
vit_sanity_check_50pct.py — Linear Probing sobre el ViT de Fase 2 (BLIP-2 · 50 %)
=================================================================================
...
Uso
---
    python vit_sanity_check_50pct.py
    python vit_sanity_check_50pct.py --epochs 20 --batch-size 64
    python vit_sanity_check_50pct.py --max-train-samples 0   # dataset COMPLETO (133K)
    python vit_sanity_check_50pct.py --no-phase2             # ablación: ViT base sin Fase 2
...
OUTPUT_DIR = BASE_DIR / "vit_sanity_check_results_50pct"
...
def main() -> int:
    ...
    logger.info(f"\n{'='*65}")
    logger.info("  VIT SANITY CHECK — Linear Probing CheXpert 14 clases (50 %)")
